...
public class Copy_2_of_MacroMap extends ScrollView {
  ...
  public Copy_2_of_MacroMap(Context context) {
    super(context);
    init(null, 0);
  }

  public Copy_2_of_MacroMap(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs, 0);
  }

  public Copy_2_of_MacroMap(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init(attrs, defStyle);
  }
